...
YouTube transcript extraction is intentionally not part of `ctx read`; ask the user for an exported transcript file instead of trying YouTube video URLs directly.
