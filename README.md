...
YouTube video URLs are rejected with a clear unsupported error. `ctx` does not provide transcript extraction because that path depends on unstable authenticated extraction and external downloader behavior.
